...
if __name__ == '__main__':
    ...
    parser.add_argument('gt_dir', type=str, help='Folder containing ground truth json files with hashed filenames.')
    parser.add_argument('source_flac_dir', type=str, help='Location of the source flac files.')
    parser.add_argument('dest_flac_dir', type=str, help='Location to place the new flac files.')
